                     ...
                     <div class="row">
                         <div class="col-sm-12 col-lg-3 ec-footer-contact">
                             <div class="ec-footer-widget">
                                 <div class="ec-footer-logo"><a href="#"><img src="{{ url('assets/frontend/images/logo/footer-logo.png') }}"
                                             alt=""><img class="dark-footer-logo" src="{{ url('assets/frontend/images/logo/dark-logo.png') }}"
                         ...
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 ...
                                 <div class="ec-img-cont">
                                     <img src="{{ url('assets/frontend/images/whatsapp/profile_01.jpg') }}" class="ec-user-img"
                                         alt="Profile image">
                     ...
                     <li>
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 <!-- Profile Picture -->
                                 <div class="ec-img-cont">
                                     <img src="{{ url('assets/frontend/images/whatsapp/profile_02.jpg') }}" class="ec-user-img"
                                         alt="Profile image">
                     ...
                     <li>
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 <!-- Profile Picture -->
                                 <div class="ec-img-cont">
                                     <img src="{{ url('assets/frontend/images/whatsapp/profile_03.jpg') }}" class="ec-user-img"
                                         alt="Profile image">
                     ...
                     <li>
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 <!-- Profile Picture -->
                                 <div class="ec-img-cont">
                                     <img src="{{ url('assets/frontend/images/whatsapp/profile_04.jpg') }}" class="ec-user-img"
                                         alt="Profile image">
                                     <span class="ec-status-icon ec-offline"></span>
                                 </div>
                                 <!-- Display Name & Last Seen -->
         ...
         <div class="ec-right-bottom">
             <div class="ec-box">
                 <div class="ec-button rotateBackward">
                     <img class="whatsapp" src="{{ url('assets/frontend/images/common/whatsapp.png') }}" alt="whatsapp icon">
                 </div>
             </div>
         </div>
