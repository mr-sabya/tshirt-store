        ...
        <div class="card-body">
            <form wire:submit.prevent="save">
                ...
                <div class="form-group mb-3">
                    ...
                    @if ($image)
                    <img src="{{ $image->temporaryUrl() }}" class="img-fluid mt-2" width="150">
                    @endif
                </div>

                <div class="form-group mb-3">
                    <label for="details">Product Details</label>
                    <textarea id="details" class="form-control" wire:model="details"></textarea>
                    @error('details') <span class="text-danger">{{ $message }}</span> @enderror
                </div>

                <div class="form-group mb-3">
                    <label for="short_desc">Short Description</label>
                    <input type="text" id="short_desc" class="form-control" wire:model="short_desc">
