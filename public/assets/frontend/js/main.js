...
function ecCheckCookie() {
    ...
    if (bgImageMode != "") {
        ...
        $("#bg-switcher-css").attr("href", "assets/frontend/css/backgrounds/" + bgID + ".css");
    }
    ...
    if (rtlMode != "") {
        ...
        var $link = $('<link>', {
            rel: 'stylesheet',
            href: 'assets/frontend/css/rtl.css',
            class: 'rtl'
        });
    ...
    if (darkMode != "") {
        var $link = $('<link>', {
            rel: 'stylesheet',
            href: 'assets/frontend/css/dark.css',
            class: 'dark'
        });

        $("link[href='assets/frontend/css/responsive.css']").before($link);
        ...
        if (themeColor != "") {
            ...
            if (themeColor != '01') {
                $("link[href='assets/frontend/css/responsive.css']").before('<link rel="stylesheet" href="assets/frontend/css/skin-' + themeColor + '.css" rel="stylesheet">');
            }
        }
    }
}
